    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="rounded-lg border border-border bg-background px-4 py-2 text-sm font-medium text-foreground hover:bg-accent/20"
          >
            Voltar ao início
          </a>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Minha Clínica — Sistema completo para clínicas e consultórios" },
      {
        name: "description",
        content:
          "Agenda, prontuário, financeiro, marketing e IA em um só lugar. O sistema brasileiro para clínicas que querem crescer sem complicar.",
      },
      { name: "author", content: "Minha Clínica" },
      { property: "og:site_name", content: "Minha Clínica" },
      ...
      { name: "twitter:title", content: "Minha Clínica — Sistema completo para clínicas e consultórios" },
      { name: "twitter:description", content: "Agenda, prontuário, financeiro, marketing e IA em um só lugar. Feito no Brasil." },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "manifest", href: "/manifest.webmanifest" },
      { rel: "canonical", href: "https://minhaclinica.ia.br" },
    ],
  }),
