...
const packages: Pkg[] = [
  {
    ...
    body: "Agenda, prontuário inteligente, anamnese, teleconsulta, prescrição digital, estoque e multi-unidade.",
    items: [
      "Agenda multi-profissional + Google/Outlook",
      "Prontuário + Anamnese + IA de resumo",
      "Prescrição digital com QR (Memed)",
      "Teleconsulta integrada",
      "Recepção, lista de espera e encaixe",
  ...
  },
  {
    ...
    items: [
      ...
      "Orçamentos digitais & renegociação",
  ...
  },
  {
    ...
    body: "Jornadas automáticas com IA, lembretes multicanal, programa de indicação, NPS e portal do paciente.",
    items: [
      "Jornadas automáticas (pré e pós consulta)",
      "Lembretes WhatsApp/SMS/e-mail",
      "Reativação de inativos por IA",
  ...
  },
  {
    ...
    body: "Site profissional com IA, conteúdo e SEO local, anúncios Google/Meta e gestão de reputação.",
    items: [
      "Site profissional gerado por IA",
      "Conteúdo & SEO local",
